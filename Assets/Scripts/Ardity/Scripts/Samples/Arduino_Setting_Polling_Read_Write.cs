...
public class Arduino_Setting_Polling_Read_Write : MonoBehaviour
{
    ...
    public enum Scents { Coffee, Citrus, Cinnamon, Rose, Zero };
    ...
    void Start()
    {
        ...
        //if using atomizer for this test, assign currentScent to the first scent and run the RunTest function
        if (useAtomizer)
        {
            currentScent = 1;
            //RunTest();
